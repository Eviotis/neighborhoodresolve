    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <Link href="/volunteers" className="flex flex-col items-center gap-1.5 bg-white border border-gray-100 rounded-2xl py-3 px-2 text-center active:bg-gray-50">
            <span className="text-xl">🤝</span>
            <span className="text-xs font-medium text-gray-600">Volunteers</span>
          </Link>
          <Link href="/services" className="flex flex-col items-center gap-1.5 bg-white border border-gray-100 rounded-2xl py-3 px-2 text-center active:bg-gray-50">
            <span className="text-xl">🔧</span>
            <span className="text-xs font-medium text-gray-600">Services</span>
          </Link>
          <Link href="/roles" className="flex flex-col items-center gap-1.5 bg-white border border-gray-100 rounded-2xl py-3 px-2 text-center active:bg-gray-50">
            <span className="text-xl">🎲</span>
